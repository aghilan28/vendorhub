...
export function mapProductRowToProduct(row: ProductListRow): Product {
  ...
  const categoryImageMap: Record<string, string> = {
    "atta-rice-dal": "https://images.unsplash.com/photo-1586201375761-838650074c67?auto=format&fit=crop&w=600&q=80",
    "oil-ghee": "https://images.unsplash.com/photo-1474979266365-77ec7679e374?auto=format&fit=crop&w=600&q=80",
    "masalas-spices": "https://images.unsplash.com/photo-1532336469618-7c287d9b6a4c?auto=format&fit=crop&w=600&q=80",
    "milk-curd": "https://images.unsplash.com/photo-1563636619-e9c5f3b4659a?auto=format&fit=crop&w=600&q=80",
    "butter-cheese": "https://images.unsplash.com/photo-1589985270673-7ed97a8736a6?auto=format&fit=crop&w=600&q=80",
    "mobiles": "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=600&q=80",
    "computers": "https://images.unsplash.com/photo-1496181133206-80ce9b88a53?auto=format&fit=crop&w=600&q=80",
    "fashion": "https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=600&q=80",
    "beauty": "https://images.unsplash.com/photo-1522335789203-ab3f29bcbc4e?auto=format&fit=crop&w=600&q=80",
    "general": "https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=600&q=80",
  };

  const fallbackImage = categoryImageMap[categorySlug] || \`https://picsum.photos/seed/\${row.id}/600/600\`;
  const finalImageUrl = image?.storage_path || fallbackImage;
