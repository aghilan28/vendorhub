  ...
  return (
    <aside className="h-fit rounded-lg border border-border bg-surface p-4 shadow-sm lg:sticky lg:top-24">
      ...
      <div className="mt-4 space-y-2 rounded-md border border-emerald-100 bg-emerald-50 p-3 text-xs text-emerald-800">
        <p className="flex items-center gap-2"><ShieldCheck className="size-4" /> Secure payment and GST invoice support</p>
        <p className="flex items-center gap-2"><Truck className="size-4" /> Delivery updates stay visible after checkout</p>
      </div>
    </aside>
  );
}
